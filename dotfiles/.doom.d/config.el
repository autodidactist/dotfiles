...
; (defun run-buffer ()
;   (interactive)
;   (compile (concat "compiler " buffer-file-name)))
...
(use-package org-brain
  :load-path "lisp/package/org-brain")


(defun run-buffer ()
  (interactive)
  (compile (concat "compiler " buffer-file-name)))
(global-set-key (kbd "<C-b> b") 'run-buffer)

(setq compile-command "compiler")

(set-mouse-color "gold1")

(add-hook 'compilation-mode-hook (lambda () (text-scale-increase 1.4)))
...
;; accept. For example:
;;
;;(setq doom-font (font-spec :family "SF Mono" :size 12 :weight 'semi-light;;      doom-variable-pitch-font (font-spec :family "SF Mono" :size 13))

; (setq doom-font (font-spec :family "Iosevka Nerd Font Mono" :size 12 :weight 'semi-light;;      doom-variable-pitch-font (font-spec :family "Iosevka Nerd Font Mono" :size 13))
;;
...
; (setq doom-theme 'stranger-darker)
