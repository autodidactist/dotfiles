...
" Runs a script that cleans out tex build files whenever I close out of a .tex file.
	...
	autocmd VimLeave *.d !mlclear %
	autocmd VimLeave *.ml !mlclear %
	autocmd VimLeave *.hs !mlclear %
	autocmd VimLeave *.fsx !mlclear %

	" autocmd BufWritePost *.ml !mlclear %
...
function! Monokaitoggle()
	if s:switch == 0
		...
		colorscheme monokai_pro
 		" hi LineNr ctermfg=11 guifg=#585858
		" hi! EndOfBuffer guibg=bg guifg=#444444

		set fillchars=fold:\ ,vert:\│,eob:\ ,msgsep:‾
		" hi! EndOfBuffer guibg=bg guifg=#333333
		" hi Normal guibg=NONE ctermbg=None
		" hi LineNr guibg=NONE
		" highlight CursorLineNr gui=bold guibg=NONE
...
colorscheme PaperColor
autocmd FileType c nnoremap <leader>f : !astyle --style=linux % <CR>
" autocmd FileType rust  colorscheme gruvbox
autocmd FileType cpp nnoremap <leader>f : !astyle --style=linux % <CR>
" autocmd BufReadPre *.asm let g:asmsyntax = "fasm"
autocmd BufReadPre *.asm let g:asmsyntax = "nasm"
...
" set fillchars=fold:\ ,vert:\│,eob:\ ,msgsep:‾
" set fillchars=eob:\  "" this will override fillchar
" vim.wo.fillchars='eob: ' "" Lua vim
" set fillchars+=eob:* "" Any Charecter u want

nnoremap <silent> <C-o> :set fillchars=eob:\ ,fold:\ ,vert:\│ <CR>
" nnoremap <silent> <S-n> :for i in range(1,10)\| put ='192.168.0.'.i \| endfor<CR>
function! Num(lines = 10)
...
nmap <silent> <C-t> : hi normal guibg=None \| hi linenr guibg=None <CR>
